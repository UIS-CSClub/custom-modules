...
class FollowIcons extends BlockBase {
  ...
  public function printHtml() {
    ...
    $result .= '<span class="fa-stack fa-lg icon-facebook">‌<span class="fa fa-square fa-stack-2x">‌</span> <span class="fa fa-facebook fa-stack-1x">‌</span></span>';
    ...
    $result .= '<span class="fa-stack fa-lg icon-github">‌ <span class="fa fa-square fa-stack-2x">‌‌</span> <span class="fa fa-github fa-stack-1x">‌‌</span> </span>';
    $result .= '<span class="fa-stack fa-lg icon-rss">‌ <span class="fa fa-square fa-stack-2x">‌‌‌</span> <span class="fa fa-rss fa-stack-1x">‌‌‌</span> </span>';
    return $result;
  }
